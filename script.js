...
const dispositivoData = {
    ...
    'iphone-15-pro-max': [
        ...
        //IPAD
    'ipad-1-mini':[
        ['TOUCH + VIDRO', 'R$  À VISTA / R$  EM 10X'],
        ['CONECTOR','R$ '], ['BOTÕES', 'R$ '], ['SOFTWARE', 'R$ '],],
     'ipad-2-mini':[
        ['TOUCH + VIDRO', 'R$  À VISTA / R$  EM 10X'],
        ['CONECTOR','R$ '], ['BOTÕES', 'R$ '], ['SOFTWARE', 'R$ '],],
     'ipad-3-mini':[
    ...
    'ipad-9':[
        ...
        // APPLE WATCH
    'gera-1':[['TOUCH + VIDRO', 'R$  À VISTA / R$ EM 10X'],], 
    'gera-2':[['TOUCH + VIDRO', 'R$  À VISTA / R$  EM 10X'],], 
    'gera-3':[['TOUCH + VIDRO', 'R$  À VISTA / R$  EM 10X'],],
    'gera-4':[['TOUCH + VIDRO', 'R$  À VISTA / R$  EM 10X'],],
    'gera-5':[['TOUCH + VIDRO', 'R$  À VISTA / R$  EM 10X'],],
    'gera-6':[['TOUCH + VIDRO', 'R$  À VISTA / R$  EM 10X'],],
    
    // SAMSUNG
    //LINHA A
    'samsung-a01-a01-core': [
        ['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X'], ['CONECTOR', 'R$ '], ['BOTÕES', 'R$ '], 
        ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], ['CÂMERA FRONTAL', 'R$ '], 
        ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],['LENTE CÂMERA', 'R$ '], 
        ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$'], ['SOFTWARE', 'R$ ']],
    'samsung-a02-a02s': [
        ['TELA FRONTAL PRIMEIRA LINHA VIVID', 'R$  À VISTA / R$  EM 10X'], ['CONECTOR', 'R$ '], ['BOTÕES', 'R$ '], 
        ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], ['CÂMERA FRONTAL', 'R$ '], 
        ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],['LENTE CÂMERA', 'R$ '], 
        ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'samsung-a03': [
    ...
    'samsung-a12':[
        ...
        ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'samsung-a13':[
        ['TELA PRIMEIRA LINHA VIVID', 'R$  À VISTA / R$  EM 10X'], 
        ['TELA FRONTAL ORIGINAL', 'R$  À VISTA / R$  EM 10X'], ['CONECTOR', 'R$ '], 
        ['BOTÕES', 'R$ '], ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], 
        ['CÂMERA FRONTAL', 'R$ '], ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'samsung-a14':[
        ['TELA PRIMEIRA LINHA VIVID', 'R$  À VISTA / R$  EM 10X'], 
        ['TELA FRONTAL ORIGINAL', 'R$  À VISTA / R$  EM 10X'], ['CONECTOR', 'R$ '], 
        ['BOTÕES', 'R$ '], ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], 
        ...
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'samsung-a15':[
        ['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X'],
        ['TELA PRIMEIRA LINHA VIVID', 'R$  À VISTA / R$  EM 10X'], 
        ['TELA FRONTAL ORIGINAL', 'R$  À VISTA / R$  EM 10X'], ['CONECTOR', 'R$ '], 
        ['BOTÕES', 'R$ '], ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], 
        ['CÂMERA FRONTAL', 'R$ '], ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],
    ...
    'samsung-a73':[
        ...
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'samsung-a80':[
        ['TELA PRIMEIRA LINHA S/ ARO', 'R$  À VISTA / R$  EM 10X'], 
        ['TELA FRONTAL ORIGINAL', 'R$  À VISTA / R$  EM 10X'], ['CONECTOR', 'R$ '], 
        ['BOTÕES', 'R$ '], ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], 
        ['CÂMERA FRONTAL', 'R$ '], ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    ...
    //LINHA J 
    'samsung-j2p':[
        ['TELA PRIMEIRA LINHA VIVID', 'R$  À VISTA / R$  EM 10X'],['CONECTOR', 'R$ '], 
        ['BOTÕES', 'R$ '], ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], 
        ['CÂMERA FRONTAL', 'R$ '], ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'samsung-j2c':[
    ...
    // LINHA M 
    'samsung-m10':[
        ['TELA FRONTAL INCELL', 'R$  À VISTA / R$ 220,00 EM 10X'], ['CONECTOR', 'R$ '], ['BOTÕES', 'R$ '], 
        ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], ['CÂMERA FRONTAL', 'R$ '], 
        ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],['LENTE CÂMERA', 'R$ '], 
        ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'samsung-m12':[
        ['TELA FRONTAL PRIMEIRA LINHA VIVID', 'R$  À VISTA / R$  EM 10X'], ['CONECTOR', 'R$ '], 
        ['BOTÕES', 'R$ '], ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], 
        ['CÂMERA FRONTAL', 'R$ '], ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'samsung-m13':[
    ...
    'samsung-m21s':[
        ...
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'samsung-m22':[
        ['TELA FRONTAL PRIMEIRA LINHA VIVID', 'R$  À VISTA / R$  EM 10X'],
        ['TELA FRONTAL ORIGINAL', 'R$  À VISTA / R$  EM 10X'], ['CONECTOR', 'R$ '], ['BOTÕES', 'R$ '], 
        ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], ['CÂMERA FRONTAL', 'R$ '], 
        ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],['LENTE CÂMERA', 'R$ '], 
        ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'samsung-m23':[
    ...
    'moto-g51':[ 
        ...
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'moto-g52':[ 
        ['TELA FRONTAL PRIMEIRA LINHA S/ ARO', 'R$ À VISTA / R$  EM 10X'], ['CONECTOR', 'R$ '], 
        ['BOTÕES', 'R$ '], ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], 
        ['CÂMERA FRONTAL', 'R$ '], ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'moto-g53':[ 
    ...
    'moto-g71':[ 
        ...
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'moto-g72':[ 
        ['TELA FRONTAL VIVID S/ ARO', 'R$  À VISTA / R$  EM 10X'], 
        ['TELA FRONTAL ORIGINAL', 'R$ À VISTA / R$  EM 10X'],['CONECTOR', 'R$ '], ['BOTÕES', 'R$ '], 
        ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], ['CÂMERA FRONTAL', 'R$ '], 
        ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],['LENTE CÂMERA', 'R$ '], 
        ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    ...
    'moto-hyper':[
        ['TELA FRONTAL PRIMEIRA LINHA VIVID', 'R$  À VISTA / R$  EM 10X'],
        ['TELA FRONTAL ORIGINAL', 'R$  À VISTA / R$ 450,00 EM 10X'],['CONECTOR', 'R$ '], ['BOTÕES', 'R$ '], 
        ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], ['CÂMERA FRONTAL', 'R$ '], 
        ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],['LENTE CÂMERA', 'R$ '], 
        ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'moto-action':[
    ...
    'moto-edge-20-pro':[
        ...
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']], 
    'moto-edge-20-lite':[
        ['TELA FRONTAL PRIMEIRA LINHA S/ ARO', 'R$  À VISTA / R$  EM 10X'],
        ['TELA FRONTAL ORIGINAL', 'R$  À VISTA / R$  EM 10X'], ['CONECTOR', 'R$ '], 
        ['BOTÕES', 'R$ '], ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], 
        ['CÂMERA FRONTAL', 'R$ '], ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']], 
    ...
    'moto-edge30':[
        ['TELA FRONTAL VIVID S/ ARO', 'R$  À VISTA / R$  EM 10X'],
        ['TELA FRONTAL VIVID C/ ARO', 'R$  À VISTA / R$  EM 10X'],
        ['TELA FRONTAL ORIGINAL', 'R$ 3 À VISTA / R$  EM 10X'], ['CONECTOR', 'R$ '], 
        ['BOTÕES', 'R$ '], ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], 
        ['CÂMERA FRONTAL', 'R$ '], ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']], 
    'moto-edge-30-neo':[
        ...
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']], 
    'moto-edge-30-fusion':[
        ['TELA PRIMEIRA LINHA S/ ARO', 'R$  À VISTA / R$  EM 10X'],['CONECTOR', 'R$ '], 
        ['BOTÕES', 'R$ '], ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], 
        ['CÂMERA FRONTAL', 'R$ '], ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']], 
    'moto-edge-40':[
    ...
    'xiaomi-note7':[
        ['TELA FRONTAL VIVID C/ ARO', 'R$  À VISTA / R$  EM 10X'],
        ['TELA FRONTAL VIVID S/ ARO', 'R$  À VISTA / R$  EM 10X'],['CONECTOR', 'R$ '], ['BOTÕES', 'R$ '], 
        ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], ['CÂMERA FRONTAL', 'R$ '], 
        ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],['LENTE CÂMERA', 'R$ '], 
        ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'xiaomi-note8':[
    ...
    'xiaomi-mi9t':[
        ...
        ['LENTE CÂMERA', 'R$ '], ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'xiaomi-mi9-lite':[
        ['TELA FRONTAL PRIMEIRA LINHA S/ ARO', 'R$  À VISTA / R$ EM 10X'],['CONECTOR', 'R$ '], ['BOTÕES', 'R$ '], 
        ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], ['CÂMERA FRONTAL', 'R$ '], 
        ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],['LENTE CÂMERA', 'R$ '], 
        ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'xiaomi-mi9se':[
    ...
    'xiaomi-poco-x5':[ 
        ['TELA FRONTAL PRIMEIRA LINHA VIVID', 'R$  À VISTA / R$ EM 10X'],
        ['TELA FRONTAL ORIGINAL', 'R$  À VISTA / R$  EM 10X'],['CONECTOR', 'R$ 0'], ['BOTÕES', 'R$ '], 
        ['MICROFONE', 'R$ '], ['BATERIA', 'R$ '],['CÂMERA TRASEIRA', 'R$ '], ['CÂMERA FRONTAL', 'R$ '], 
        ['FPC', 'R$ '], ['TAMPA / CARCAÇA', 'R$ '], ['VIDRO TELA', 'R$ '],['LENTE CÂMERA', 'R$ '], 
        ['ALTO FALANTE', 'R$ '],['AURICULAR', 'R$ '], ['SOFTWARE', 'R$ ']],
    'xiaomi-poco-x5-pro':[ 
    ...
    // REALME
    // LINHA C
    'realme-c2':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-c3':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-12c':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-c11':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-c12':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-c15':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-c20':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-c25':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']], 
    'realme-c30':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-c33':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-c35':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-c53':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-c55':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-c65':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-c67':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    // LINHA -
    'realme-6':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']], 
    'realme-7':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-7-pro':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-8-4g':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-8-5g':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-8-pro':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-9':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'realme-10':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    // GT
    'realme-gt2':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    ...
    // INFINIX
    // LINHA HOT
    'infinix-hot-8-lite':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-hot-10':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-hot-10-play':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-hot-11':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-hot-11s':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-hot-11-pro':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-hot-40-pro':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-hot-30-i':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-hot-20-i':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-hot-20-play':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    // LINHA NOTE
    'infinix-note-10-pro':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-note-11':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-note-11-pro':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-note-12-pro':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    // LINHA SPARK
    'infinix-spark-6-go':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-spark-6':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-spark-7':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'infinix-spark-8':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],


    // NOKIA
    // LINHA C
    'nokia-c01':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']], 
    'nokia-c11':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'nokia-c20':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'nokia-c30':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'nokia-c50':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    // LINHA G
    'nokia-g20':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'nokia-g21':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'nokia-g50':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],   
    // LINHA -
    'nokia-2.3':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'nokia-2.4':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'nokia-3.1':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'nokia-5.3':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'nokia-6.1':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
    'nokia-6.2':[['TELA FRONTAL INCELL', 'R$  À VISTA / R$  EM 10X']],
...
function criarMobileOverlay() {
    ...
    window.addEventListener('popstate', function () {
        if (_ignorarPopstate) return;

        const overlay = document.getElementById('mobile-page-overlay');
        if (!overlay || !overlay.classList.contains('open')) return;

        // Reinsere o estado fixo para travar o browser
...
function abrirMobilePage(titulo, linhas, whatsappUrl) {
    ...
    // Empurra UM ÚNICO estado fixo — só na abertura
...
function voltarMobilePage() {
    ...
    if (mobileNavStack.length === 0) {
        ...
        // Silencia o listener antes de chamar history.back()
        // para não disparar voltarMobilePage() de novo em loop
        _ignorarPopstate = true;
        history.back();
        setTimeout(() => { _ignorarPopstate = false; }, 100);
        return;
    }
